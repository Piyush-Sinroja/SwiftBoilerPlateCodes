...
open class ZoomImageView: UIScrollView, UIScrollViewDelegate {
    ...
    @objc dynamic public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        delegateZoomImage?.scrollDidScroll(scrollView: scrollView)
    }
