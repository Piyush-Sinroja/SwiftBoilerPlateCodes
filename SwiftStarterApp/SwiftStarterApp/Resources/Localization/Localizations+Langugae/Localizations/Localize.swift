...
//  SwiftStarterApp
//
//  Created by Piyush Sinroja on 11/20/23.
//
...
open class Localize: NSObject {
    ...
    open class func availableLanguages(_ excludeBase: Bool = false) -> [String] {
        ...
        if let indexOfBase = availableLanguages.firstIndex(of: "Base"), excludeBase == false {
...
//        if selectedLanguage != currentLanguage() {
            ...
            let isLanguageRTL = Locale.characterDirection(forLanguage: selectedLanguage) == .rightToLeft
            ...
            UITextField.appearance().semanticContentAttribute = isLanguageRTL == true ? .forceRightToLeft : .forceLeftToRight
